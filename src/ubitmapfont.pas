...
{ Public-domain IBM VGA 8x8 (Marcel Sondaar / Daniel Hepper font8x8).
  Bit 0 of each row byte is the leftmost pixel. Draws into an RGBA buffer. }

interface

procedure DrawGlyphText(P: PByte; Width, Height, X, Y: Integer;
  const Text: string; R, G, B: Byte; Scale: Integer);
function GlyphTextWidth(const Text: string; Scale: Integer): Integer;
function GlyphTextHeight(Scale: Integer): Integer;
...
procedure Plot(P: PByte; Width, Height, X, Y: Integer; R, G, B: Byte);
var
  I: Integer;
begin
        ...
        if (Glyph[Row] and (1 shl Col)) <> 0 then
          ...
          for SY := 0 to Scale - 1 do
            ...
            begin
              ...
              PY := Y + Row * Scale + SY;
              Plot(P, Width, Height, PX, PY, R, G, B);
            end;
  end;
end;
